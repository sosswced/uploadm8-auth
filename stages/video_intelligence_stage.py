...
async def run_video_intelligence_stage(ctx: JobContext) -> JobContext:
    ...
    if not user_pref_ai_service_enabled(ctx.user_settings or {}, "video_intelligence", default=True):
        raise SkipStage("Video Analyzer disabled in upload preferences (aiServiceVideoAnalyzer)")
