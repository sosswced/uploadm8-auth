"""
UploadM8 — Phase 2: Billing Subscription Emails
================================================
...
All five are currently silent in app.py — these fill every gap.
"""
...
async def send_renewal_receipt_email(
    ...
    receipt_lines = (
        ...
        + receipt_row(f"Amount Charged", f"${amount:.2f}", is_total=True)
        + "</table>"
    )
