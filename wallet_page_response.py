...
async def fetch_me_wallet_endpoint_data(
    pool: Any, user_id: str
) -> Tuple[dict[str, Any], dict[str, Any], list[Any]]:
    """
    Data for ``GET /api/wallet`` (routers/me.py): one pooled connection for users row
    ...
    async with pool.acquire() as conn:
        ...
        user = dict(user_row)
        wallet = await get_wallet_core(conn, user_id)
        ...
        try:
            ...
            ledger = []
    return wallet, plan_limits, list(ledger)
