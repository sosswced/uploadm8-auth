...
class UserPreferencesUpdate(BaseModel):
    ...
    use_audio_context: bool = Field(False, alias="useAudioContext")
    youtube_shorts_copyright_trim: bool = Field(False, alias="youtubeShortsCopyrightTrim")
    audio_transcription: bool = Field(False, alias="audioTranscription")
    ai_service_telemetry: bool = Field(False, alias="aiServiceTelemetry")
    ai_service_dashcam_osd: bool = Field(False, alias="aiServiceDashcamOSD")
    ai_service_audio_signals: bool = Field(False, alias="aiServiceAudioSignals")
    ai_service_music_detection: bool = Field(False, alias="aiServiceMusicDetection")
    ai_service_audio_summary: bool = Field(False, alias="aiServiceAudioSummary")
    ai_service_emotion_signals: bool = Field(False, alias="aiServiceEmotionSignals")
    ai_service_caption_writer: bool = Field(False, alias="aiServiceCaptionWriter")
    ai_service_thumbnail_designer: bool = Field(False, alias="aiServiceThumbnailDesigner")
    ai_service_frame_inspector: bool = Field(False, alias="aiServiceFrameInspector")
